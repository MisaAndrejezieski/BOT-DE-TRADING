...
class ExchangeManager:
    ...
    def create_buy_order(self, symbol: str = 'BTC/USDT', amount: float = 0.001) -> Optional[Dict]:
    ...
    def create_sell_order(self, symbol: str = 'BTC/USDT', amount: float = 0.001) -> Optional[Dict]:
        """Cria ordem de venda"""
        try:
